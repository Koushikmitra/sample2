...
import com.webtek.modules.ContactAction;
...
public class SanityTest1 extends SelTestCase {
	...
	public void verifyItemPresentInCartAndSummation() throws Exception {
	 ...
	 @Test(priority = 4)
	public void ContactDetailSubmission() throws Exception {

		 PageFactory.initElements(driver, HomePage.class);
		 PageFactory.initElements(driver, ContactusPage.class);
		 
		 try{
			 ContactAction.executed();
			 Log.info("Contact Details had been submitted successfully");
			 } catch (Exception e){
			Log.error("Contact details had not submitted successfully");	 
			 }
